            ...
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="menuHover box-icon">
                        <a href="./verifyUser.jsp" class="nav-link text-left active" role="button">
        ...
        <div id="page-content-wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <!-- Begin Page Content -->
                    <div class="container">
                        <h3 class="text-light">Verify User Account</h3>
                        <div class="w-50">
                            ...
                            <div class="col-lg-12">
                                <div class="veryfy-user-account pb-4">
                                    <div class="card bg-dark">
                                        <div class="card-title text-light">Veryfy User Account <br>
                                            <span class="verify-text text-light">Vew All the user who is not Verified</span>
                                        </div>
                                            ...
                                            <table class="table table-hover table-dark">
                                                ...
                                                <%
														...
														try{
													        ...
													        PreparedStatement ps = con.prepareStatement("select * from register where userStatus='F'");
													        ...
													        while(rs.next()){
													        	...
													        	<tbody>
				                                                   <tr>
				                                                        ...
				                                                        <td>
				                                                        	<form action="../Jsp/verifyPageUserDetails.jsp" method="post">
                        ...
                        <div id="id01" class="modal">
                            <div class="model-content">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card py-3">
                                            <form action="./jsp/verifyPageUserDetails.jsp">
                                                <div class="card-body">
