        ...
        <div id="page-content-wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <!-- Begin Page Content -->
                    <div class="container">
                        <h3 class="text-light">Edit Account Details</h3>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="veryfy-user-account pb-4">
                                    <div class="card bg-dark">
                                        <div class="card-title text-light">Edit Account Details <br>
                                            <span class="verify-text text-light">Edit All User Account Details</span>
                                        </div>
												        ...
												        while(rs.next()){
												        	...
												        	<tbody>
	                                                    		<tr>
	                                                        		...
	                                                        		<td class="text-warning"><a href="./editProfileByAdmin.jsp?userName=<%=rs.getString(14)%>" class="btn btn-primary">Edit</a></td>
