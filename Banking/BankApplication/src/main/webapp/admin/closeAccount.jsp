        ...
        <div id="page-content-wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <!-- Begin Page Content -->
                    <div class="container">
                        <h3 class="text-light">Delete Account Details</h3>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="veryfy-user-account pb-4">
                                    <div class="card bg-dark">
                                        <div class="card-title text-light">Delete User Account <br>
                                            <span class="verify-text text-light">Delete User Account</span>
                                        </div>
												        ...
												        while(rs.next()){
												        	...
												        	<tbody>
	                                                    		<tr>
	                                                        		...
	                                                        		<td class="text-warning"><a href="./CloseAccountByAdmin.jsp?userName=<%=rs.getString(14)%>" class="btn btn-danger">Delete</a></td>
