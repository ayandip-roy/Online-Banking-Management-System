...
<%
	...
	try{
        ...
        while(rs1.next()){
        	...
        	updateBalane =  accountbalanceOldD - sendAmount;
        	
        
        
        if(accountbalanceOldD>sendAmount){
    		...
    		out.println("alert('Money Withdraw Sucessfully... !');");
    		out.println("location='../admin/withdrawMoney.html';");
    		out.println("</script>");
        }
        else{
        	out.println("<script type=\"text/javascript\">");
